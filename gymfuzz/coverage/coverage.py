...
from gymfuzz.coverage.forkclient import ForkClient
from gymfuzz.coverage.forkclient import STATUS_CRASHED
...
class Coverage:
    ...
    def add(self, coverage):
        # add transitions in a new step to whole
        ...
        # add count_paths in a new step to whole
        ...
        # add skip_paths in a new step to whole
